...
function M:newUI( options )
	...
	print ("Bar container X " .. barContainer.x)
	print ("Bar container Y " .. barContainer.y)
...
--	topBarBack:toBack()
	...
	--GJH--local title = display.newText( barContainer, sampleCodeTitle, barContainer.contentWidth - 28, topBarOver.contentHeight / 2, useFont, 14 )
	--GJH--title.anchorX = 1
	...
	local function onResize( event )
		...
		--GJH--title.x = barContainer.contentWidth - 28
		infoButton.x = barContainer.contentWidth - 3
